...
effect of complex exposure mixtures on an outcome ([Carrico 2015](https://doi.org/10.1007/s13253-014-0180-3)). It is a 
...
algorithm is described more in detail and validated in [Day et al. 2022](https://doi.org/10.1289/EHP10570). 
...
and [Freije et al. 2022](https://doi.org/10.1016/j.envint.2022.107246).
